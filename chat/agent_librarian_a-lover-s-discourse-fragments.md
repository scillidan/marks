...
A: 这段话是在说明《Fragments d'un discours amoureux》的写作立场与方法。巴特并不想把"恋人"当作心理学或精神分析中的病例来解释，而是试图保存恋爱话语本身的独特性：它不合时宜、难以规训，也无法被轻易化约为某种症状。因此，他拒绝站在外部用"元语言"加以分析，而让恋人的"我"直接发声，以一种近乎戏剧独白的方式呈现爱情中的言说状态。所谓"模拟"爱情话语，不是复制现实中的恋人，而是搭建一个结构性的发言位置：一个人在内心不断对所爱者说话，而对方却沉默无言。重要的不是恋人的心理画像，而是"谁在何种位置上说话"。巴特借此把爱情从对象化的研究中抽离出来，转而展示它作为语言事件的生成方式：爱首先不是一种被解释的情感事实，而是一种不断说出自身、又始终得不到回应的话语处境。