...
> The rule of thumb should always be to pay off your debts first, then start accumulating assets because you don’t want to try to pay for assets when you have debts holding you down. [Michael Bastos, "Technical debt vs technical assets: What-s the difference?"]

译：有些人将技术债务视为一份缺失功能的清单，但它应该是你知道自己必须解决与想要解决的问题的清单。清单内容可能会有所不同，但应包括你代码中已知的错误和缺陷。它还应包括代码的可读性以及可能存在的冗余。构建和执行时间的缓慢也需要考虑。  
