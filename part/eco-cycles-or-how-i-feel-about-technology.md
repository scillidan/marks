...
译：每个平台、每个工具、每个新界面都是为了自我传播而构建的。你的手机希望被使用。你的动态希望被滚动。你的收件箱希望保持满状态。这并不是什么个人行为——这只是系统在开始选择注意力后运作的方式。  
技术并不关心你是否感到满足。它只需要你参与足够长的时间以便传播自己。因此，我们成为了承载者——其扩展的活体容器。我们优化、自动化、发布、点击和滚动，不是为了自己，而是为了这个系统。