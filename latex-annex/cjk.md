...
译：CJK是一个LaTeX宏包，提供对多种亚洲文字的同时支持，涵盖多种编码（包括Unicode）：中文（繁体和简体）、日文、韩文和泰文。  
一个特别的附加功能是与Emacs编辑器的接口（cjk-enc.el），除了上述文字外，还为其他多种文字提供了同时且易于使用的支持——支持西里尔字母、希腊字母、拉丁字母、俄文和越南文。