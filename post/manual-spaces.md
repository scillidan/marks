...
![](assets/manual-spaces_01.png)  
Diagram of a cast metal sort, **c** is point size

![](assets/manual-spaces_02.png)  
Whitespace characters in [Gauge](https://type.today/en/collection/gauge). Widths and correlations between spaces differ depending on the typeface
...
Standard space, word space, space _per se,_ is the symbol typed using the widest key on the keyboard.
...
> 
> **Alexandra Korolkova**  
> [Living Typography (2012)](https://yadi.sk/i/oy19NzNjydZjR)
...
> It used to be a rule of thumb for headline settings to leave a space between words that is just wide enough to fit in a lowercase **i**. For comfortable reading of long lines, the space between words should be much wider.
> 
> **Erik Spiekermann**  
> [Stop stealing sheep & find out how type works (1993)](https://www.oreilly.com/library/view/stop-stealing-sheep/9780133441147/#:~:text=Book%20description,type%20lovers%20around%20the%20globe.)
...
> 
> **Jost Hochuli**  
> [Detail in Typography (2008)](https://www.typotheque.com/books/detail_in_typography)
...
![](assets/manual-spaces_04.png)  
Word spaces as set in [Kazimir Text](https://type.today/en/kazimir-text). The space width is good: words are separated from one another, the hierarchy of white space is maintained

![](assets/manual-spaces_05.png)  
If you increase word spacing, word spaces would conflict with leading, which makes it hard to navigate through the text

![](assets/manual-spaces_06.png)  
...
> 
> **María Ramos Silva**  
> [Type design for typewriters: Olivetti (2015)](https://www.academia.edu/15850041/Type_design_for_typewriters_Olivetti)
...
> 
> **Matthew Butterick**  
> [Butterick’s Practical Typography (2013)](https://practicaltypography.com)
...
> 
> **Jan Tschichold**  
> [The Form Of The Book (1975)](https://vsip.info/qdownload/the-form-of-the-book-essays-on-the-mora-jan-tschichold-pdf-free.html)
...
> 
> **Robert Bringhurst**  
> [The Elements of Typographic Style (1992)](https://www.amazon.com/Elements-Typographic-Style-Robert-Bringhurst/dp/0881791326)
...
![](assets/manual-spaces_07.png)  
Standard space in [Spectral](https://type.today/en/spectral) is too wide to be used for spacing initials and dashes

![](assets/manual-spaces_08.png)  
...
> 
> **Pyotr Kolomnin**  
> [A Concise Account of Typography (1899)](https://www.artlebedev.com/izdal/kratkie-svedenia-po-tipografskomu-delu/)
...
| Non-breaking space | MacOS: Alt + Space<br />Windows: Alt+0160<br />Unicode: U00A0<br />HTML: &amp;nbsp;<br /><br />Indesign: Type → Insert White Space → Nonbreaking Space or Alt + Cmnd + X<br />in case you need a space of non-changing width, in a justified text layout:<br />Type → Insert White Space → Nonbreaking Space (Fixed Width) |
|:-|:-|
| Thin space | Unicode: U2009<br />HTML: &amp;ThinSpace;<br /><br />Indesign: Type → Insert White Space → Thin Space<br />or<br />Shift + Alt + Cmnd + M |
| Thin non-breaking space<br />(for Web) | Unicode: U202F<br />HTML: &amp;#8239; |
| Em&nbsp;space | Unicode: U2003<br />HTML: &amp;emsp;<br /><br />Indesign: Type → Insert White Space → Em&nbsp;Space |
| En&nbsp;space | Unicode: U2002<br />HTML: &amp;ensp;<br /><br />Indesign: Type → Insert White Space → En&nbsp;Space |
| Third space | Unicode: U2004<br />HTML: &amp;emsp13;<br /><br />Indesign: Type → Insert White Space → Third Space |
| Quarter space | Unicode: U2005<br />HTML: &amp;emsp14;<br /><br />Indesign: Type → Insert White Space → Quarter Space |
| Sixth space | Unicode: U2006<br />HTML: &amp;#8198;<br /><br />Indesign: Type → Insert White Space → Sixth Space |
| Hair space | Unicode: U200A<br />HTML: &amp;hairsp;<br /><br />Indesign: Type → Insert White Space → Hair Space |
| Figure space | Unicode: U2007<br />HTML: &amp;numsp;<br /><br />Indesign: Type → Insert White Space → Figure Space |
| Punctuation space | Unicode: U2008<br />HTML: &amp;puncsp;<br /><br />Indesign: Type → Insert White Space → Punctuation Space |

## References

### In English

Kirill Belyayev, [Whitespaces and zero width characters with buttons for copying to clipboard, short mnemonics and usage comments](https://kirillbelyaev.com/s/)  
Robert Bringhurst, [The Elements of Typographic Style](https://www.amazon.com/Elements-Typographic-Style-Robert-Bringhurst/dp/0881791326)  
Matthew Butterick, [Butterick’s Practical Typography](https://practicaltypography.com/word-spaces.html)  
Jost Hochuli, [Detail in Typography](https://www.typotheque.com/books/detail_in_typography)  
Yves Peters, [Adventures in Space (fontshop.com)](https://www.fontshop.com/content/adventures-in-space_spaces)  
María Ramos Silva, [Type design for typewriters: Olivetti](https://www.academia.edu/15850041/Type_design_for_typewriters_Olivetti)  
Erik Spiekermann, [Stop stealing sheep & find out how type works](https://www.oreilly.com/library/view/stop-stealing-sheep/9780133441147/#:~:text=Book%20description,type%20lovers%20around%20the%20globe.)  
Jan Tschichold, [The Form Of The Book](https://vsip.info/qdownload/the-form-of-the-book-essays-on-the-mora-jan-tschichold-pdf-free.html)  
Martin Wichary, [Space Yourself (smashingmagazine.com)](https://www.smashingmagazine.com/2015/10/space-yourself/)  

### In Russian

Pyotr Kolomnin, [A Concise Account of Typography](https://www.artlebedev.com/izdal/kratkie-svedenia-po-tipografskomu-delu/)  
Alexandra Korolkova, [Living Typography](https://yadi.sk/i/oy19NzNjydZjR)  
M.I.Schelkunov, [History, Technique, Art of Printing](https://www.booksite.ru/fulltext/shelkunov/index.htm)  
Alexei Yozhikov, [(Nearly) Everything You Need To Know About Whitespace (habr.com)](https://habr.com/ru/post/23250/)